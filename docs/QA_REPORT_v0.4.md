...
v0.4 的输入导航、证据板、准心、高亮、毛玻璃 UI、HUD、设置、服装、肖像移除、NPC 开场白、意图输入流程、表达管线、回归、基线与 Shipping 归档均已完成。G0、G1、G2、G4、G5 通过；G3 只剩 V4-10 的源 Idle 动画姿势需要用户决定，整版暂为 Release Hold。
...
顾衡与叶澄当前均只播放指定 Idle，但这两套源动画本身带有前臂前伸、手掌上翻和手指张开姿势。服装、贴地、肖像移除与动画调用固化已完成；按任务清单不得擅自换骨架/动画。需要用户选择：接受为 v0.4 已知限制，或授权 DCC 修正。除此之外未发现发布阻塞。
