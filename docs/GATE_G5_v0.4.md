...
日期：2026-07-22
门禁结果：**PASS（回归与发布工程）**
整版发布状态：**HOLD — 仅等待 G3 / V4-10 Idle 动画决定**
...
| 包体 | 42 文件 / 774,388,637 bytes（约 738.5 MiB）/ 2.5 GB 预算内 |
...
G5 本身全部通过，但 G3 尚未签字：两套指定 Idle 源动画均自带前臂前伸、手掌上翻姿势。根据 V4-10 的停止条件，未擅自换骨架或换动画。详见 `docs/GATE_G3_v0.4.md`。用户选择“接受已知限制”或授权 DCC 修正后，方可解除整版 HOLD。
