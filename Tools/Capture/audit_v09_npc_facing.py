#!/usr/bin/env python3
"""Fail closed unless all v0.9 runtime-facing captures passed."""
...
EVIDENCE = ROOT / "docs" / "evidence_v0.9"
...
def main() -> int:
    ...
    for capture in CAPTURES:
        ...
        if record.get("schema") != "whiteout.v0.9.npc-facing-audit.v1":
    ...
    if failures:
        ...
        print(f"NPC FACING AUDIT v0.9: FAIL ({len(failures)} error(s))")
        return 1
    print("NPC FACING AUDIT v0.9: PASS (3/3 distances)")
    return 0
