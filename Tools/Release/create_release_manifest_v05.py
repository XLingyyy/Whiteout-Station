"""Create the checksum/provenance manifest for a completed v0.5 package.
...
def create_manifest(
    ...
    *,
    ...
    if not RUN_ID_PATTERN.fullmatch(run_id):
        raise GateError("run_id does not match the v0.5 unique-run format")
    expected_name = f"WhiteoutStation-v0.5-Win64-{run_id}"
...
def main() -> int:
    ...
    try:
        ...
        print(f"MANIFEST v0.5: FAIL: {exc}")
        return 1
    print(f"MANIFEST v0.5: CREATED {manifest_path}")
    return 0
