"""Create the checksum/provenance manifest for a completed v0.6 package.
...
def create_manifest(
    ...
    *,
    ...
    if not RUN_ID_PATTERN.fullmatch(run_id):
        raise GateError("run_id does not match the v0.6 unique-run format")
    expected_name = f"WhiteoutStation-v0.6-Win64-{run_id}"
...
def main() -> int:
    ...
    try:
        ...
        print(f"MANIFEST v0.6: FAIL: {exc}")
        return 1
    print(f"MANIFEST v0.6: CREATED {manifest_path}")
    return 0
