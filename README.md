...
v0.4 已完成全局 ESC 返回、可点击证据板、固定十字准心与细白高亮、统一低遮挡毛玻璃 UI、HUD/对话肖像移除、叶澄夹克、NPC 开场白、四意图与可选玩家输入、离线/在线表达降级链，以及双分辨率基线和 Win64 Shipping 归档。当前仅剩两套指定 Idle 源动画的前伸手臂姿势等待“接受已知限制”或“授权 DCC 修正”的决定；详见 `docs/PROGRESS_v0.4.md`。
